...
from `aec-students.dbt_leonwichette.orders` as orders
left join `aec-students.dbt_leonwichette.order_items` as order_items on
orders.order_id = order_items.order_id
left join `aec-students.dbt_leonwichette.products` as products
